...
input double RMC_MinConfirmMagnitude = 0.10; // RMC must be at least this far from zero (of its -1..+1 range) to count as a real red/blue reading, not noise sitting on the zero line
